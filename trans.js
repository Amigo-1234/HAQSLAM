...
const totalSecondPages = 16; // Update this to the total number of pages in IMAGE1 folder
...
function updateSecondNavigation() {
  ...
  secondEbookImage.src = `IMAGE3/${String(currentSecondPage).padStart(2, '0')}.png`;
